...
local function onUpdateReceive(update)
end
E.onUpdateReceive = onUpdateReceive

local function onTextReceive(message)
end
E.onMessageReceive = onMessageReceive

local function onPhotoReceive(message)
end
E.onPhotoReceive = onPhotoReceive

local function onAudioReceive(message)
end
E.onAudioReceive = onAudioReceive

local function onDocumentReceive(message)
end
E.onDocumentReceive = onDocumentReceive

local function onStickerReceive(message)
end
E.onStickerReceive = onStickerReceive

local function onVideoReceive(message)
end
E.onVideoReceive = onVideoReceive

local function onVoiceReceive(message)
end
E.onVoiceReceive = onVoiceReceive

local function onContactReceive(message)
end
E.onContactReceive = onContactReceive

local function onLocationReceive(message)
end
E.onLocationReceive = onLocationReceive

local function onLeftChatParticipant(message)
end
E.onLeftChatParticipant = onLeftChatParticipant

local function onNewChatParticipant(message)
end
E.onNewChatParticipant = onNewChatParticipant

local function onNewChatTitle(message)
end
E.onNewChatTitle = onNewChatTitle

local function onNewChatPhoto(message)
end
E.onNewChatPhoto = onNewChatPhoto

local function onDeleteChatPhoto(message)
end
E.onDeleteChatPhoto = onDeleteChatPhoto

local function onGroupChatCreated(message)
end
E.onGroupChatCreated = onGroupChatCreated

local function onSupergroupChatCreated(message)
end
E.onsuperGroupChatCreated = onsuperGroupChatCreated

local function onChannelChatCreated(message)
end
E.onChannelChatCreated = onChannelChatCreated

local function onMigrateToChatId(message)
end
E.onMigrateToChatId = onMigrateToChatId

local function onMigrateFromChatId(message)
end
E.onMigrateFromChatId = onMigrateFromChatId

local function onEditedMessageReceive(message)
end
E.onEditedMessageReceive = onEditedMessageReceive

local function onInlineQueryReceive(inlineQuery)
end
E.onInlineQueryReceive = onInlineQueryReceive

local function onChosenInlineQueryReceive(chosenInlineQuery)
end
E.onChosenInlineQueryReceive = onChosenInlineQueryReceive

local function onCallbackQueryReceive(CallbackQuery)
end
E.onCallbackQueryReceive = onCallbackQueryReceive

local function onChannelPost(post)
end
E.onChannelPost = onChannelPost

local function onChannelEditPost(post)
end
